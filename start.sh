#!/bin/bash
echo "Установка Andromeda Node (RUS)/Alternetive"
...
echo -e "\e[1m\e[32m	Введите наименование Валидатора:\e[0m"
echo "------------"
read Validator_Name

echo export Validator1_Name=${Validator_Name} >> $HOME/.bash_profile
